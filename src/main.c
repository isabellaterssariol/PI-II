...
typedef enum {
    MENU, INSTRUCOES,
    FASE1_CTX1, FASE1_CTX2,
    FASE2_CTX1, FASE2_CTX2,
    FASE3_CTX1, FASE3_CTX2,
    FASE1, FASE2, FASE3,
    MENU_FINAL
} GameState;
...
int main(void) {
    ...
    // Contextos Fase 1
    fase1_ctx1_img  = al_load_bitmap("assets/imagens/fase1_contexto1.png");
    fase1_ctx2_img  = al_load_bitmap("assets/imagens/fase1_contexto2.png");

    // Contextos Fase 2
    fase2_ctx1_img  = al_load_bitmap("assets/imagens/fase2_contexto1.png");
    fase2_ctx2_img  = al_load_bitmap("assets/imagens/fase2_contexto2.png");

    // Contextos Fase 3
    fase3_ctx1_img  = al_load_bitmap("assets/imagens/fase3_contexto1.png");
    fase3_ctx2_img  = al_load_bitmap("assets/imagens/fase3_contexto2.png");
    ...
    while (running) {
        ...
        // ===== CONTEXTOS — FASE 1 =====
            ...
            if (ev.type == ALLEGRO_EVENT_KEY_DOWN && ev.keyboard.keycode == ALLEGRO_KEY_ESCAPE) state = MENU;
        }
            ...
            if ((ev.type == ALLEGRO_EVENT_MOUSE_BUTTON_DOWN) ||
                ...
                x = 400; y = 450; vel_y = 0; on_ground = true; pulando = false; andando = false;
            }
            if (ev.type == ALLEGRO_EVENT_KEY_DOWN && ev.keyboard.keycode == ALLEGRO_KEY_ESCAPE) state = MENU;
        }
        ...
        // ===== CONTEXTOS — FASE 2 =====
            ...
            if ((ev.type == ALLEGRO_EVENT_MOUSE_BUTTON_DOWN) ||
                ...
                state = FASE2;
                fase_start_time = al_get_time();
                x = 400; y = 795; vel_y = 0; on_ground = true; pulando = false; andando = false;
            }
            if (ev.type == ALLEGRO_EVENT_KEY_DOWN && ev.keyboard.keycode == ALLEGRO_KEY_ESCAPE) state = MENU;
        }
        ...
        // ===== LÓGICA DAS FASES =====
            ...
            if (state == FASE1 || state == FASE2 || state == FASE3) {
                ...
                if (andando) {
                    if (al_key_down(&key_state, ALLEGRO_KEY_A)) x -= VELOCIDADE;
                    if (al_key_down(&key_state, ALLEGRO_KEY_D)) x += VELOCIDADE;
                }
                ...
                if (elapsed >= 10.0) {
                    if (state == FASE1)       state = FASE2_CTX1; // vai para contexto da próxima fase
                    else if (state == FASE2)  state = FASE3_CTX1;
                    ...
                    andando = false; pulando = false; on_ground = true; vel_y = 0;
                }
